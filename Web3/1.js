...
const degreesCels = Number.parseInt(prompt("Please input degrees!", "Celsius degrees"));
const degreesF = (9 / 5 * degreesCels + 32).toFixed();
alert(`Цельсий: ${degreesCels}, Фаренгейт: ${degreesF}`);
